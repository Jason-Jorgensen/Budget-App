    ...
    return (
        ...
        <form class="max-w-xl mx-auto p-10 bg-white rounded shadow-xl text-center">
            ...
            <div class="mt-2 grid grid-cols-2">
                ...
                <input  class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" onChange={debtsChange} name={car} id={car} type="number" required="" />
            </div>
            )}
            ...
            <div class="mt-2 grid grid-cols-2">
                ...
                <input  class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" onChange={debtsChange} name={credit} id={credit} type="number" required="" />
            </div>
            )}
            ...
            <div class="mt-2 grid grid-cols-2">
                ...
                <input  class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" onChange={debtsChange} name={mortgage} id={mortgage} type="number" required="" />
            </div>
            )}
            ...
            <div class="mt-2 grid grid-cols-2">
                ...
                <input  class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" onChange={debtsChange} name={studentLoan} id={studentLoan} type="number" required="" />
            </div>
            )}
            ...
            <div class="mt-2 grid grid-cols-2">
                ...
                <input  class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" onChange={debtsChange} name={otherLoan} id={otherLoan} type="number" required="" />
            </div>
            )}
        </form>
        <div class="flex justify-center mt-2">
                    <button onClick={() => {debtsSubmit();changeForm()}} class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-r flex-wrap content-center">
                        Next Page
                     </button>
                </div>
